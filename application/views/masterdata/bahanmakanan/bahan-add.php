          ...
          <div class="">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                ...
                <hr>
                <form class="form-horizontal form-label-left" action="<?php echo $formAdd ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="bahanName" name="bahanName" placeholder="Nama Bahan" required />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="bahanUrt" class="control-label col-md-3">URT <span class="required">*</span></label>
                        <div class="col-md-3">
                            <input type="text" class="form-control" id="bahanUrt" name="bahanUrt" placeholder="URT" required />
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="number" class="form-control" id="bahanWeight" name="bahanWeight" placeholder="Berat Bahan" required />
                        </div>
                        <div class="col-md-3">
